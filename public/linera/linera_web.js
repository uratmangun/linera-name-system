...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_static_accessor_IMPORT_META_URL_13171993f95ebebe = function(arg0) {
        const ret = (typeof window !== 'undefined' ? window.location.origin : '') + '/linera/linera_web.js';
        const ptr1 = passStringToWasm0(ret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        getDataViewMemory0().setInt32(arg0 + 4 * 1, len1, true);
        getDataViewMemory0().setInt32(arg0 + 4 * 0, ptr1, true);
    ...
    imports.wbg.__wbindgen_link_87c6db35c91e89c3 = function(arg0) {
        const ret = new URL('/linera/snippets/wasm_thread-8ee53d0673203880/src/wasm32/js/web_worker_module.js', window.location.origin).toString();
        const ptr1 = passStringToWasm0(ret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        getDataViewMemory0().setInt32(arg0 + 4 * 1, len1, true);
        getDataViewMemory0().setInt32(arg0 + 4 * 0, ptr1, true);
    ...
    imports.wbg.__wbindgen_link_9579f016b4522a24 = function(arg0) {
        const ret = new URL('/linera/snippets/wasm-bindgen-futures-72233ac8f067fce7/src/task/worker.js', window.location.origin).toString();
        const ptr1 = passStringToWasm0(ret, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        getDataViewMemory0().setInt32(arg0 + 4 * 1, len1, true);
        getDataViewMemory0().setInt32(arg0 + 4 * 0, ptr1, true);
...
async function __wbg_init(module_or_path, memory) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('/linera/linera_web_bg.wasm', window.location.origin);
    }
    const imports = __wbg_get_imports();
