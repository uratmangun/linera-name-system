...
1.  **For UI (Frontend)**: Continue doing what you are likely doing—query the **Registry Chain's** GraphQL endpoint directly from the client. This is the correct pattern for "reading" data.
